...
{
    static NXSendMail *obj = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        if (obj == nil)
        {
            obj = [[NXSendMail alloc] init];
        }
    });
                   ...
                   isHTML:(BOOL)isHTML
{
    ...
    else
    {
        [[[UIAlertView alloc]
                initWithTitle:
                    @"请去设置->邮件,通讯录,日历->添加账户 设置你常用邮件,感谢您的反馈"
                      message:@""
                     delegate:nil
                           ...
                           isHTML:(BOOL)isHTML
{
    if (isSendEmail == NO)
    {
        ...
        //                .keyWindow.rootViewController presentViewController:mailCompose
        //                                                           animated:YES
        //                                                         completion:nil];
...
//        [[UIApplication sharedApplication]
//                .keyWindow.rootViewController dismissViewControllerAnimated:YES
//                                                                 completion:nil];
